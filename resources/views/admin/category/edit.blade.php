                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="slug" value="{{ $category->slug }}"
                                        class="form-control form-control-sm" placeholder="Enter Category Slug">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <img src="{{ asset('uploads/category/'.$category->image) }}" class=" mt-2 col-sm col-md-2 img-thumbnail"
                                        alt="Img" srcset="">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="meta_title" value="{{ $category->meta_title }}"
                                        class="form-control form-control-sm" placeholder="Enter Category Meta Title">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="meta_keyword" value="{{ $category->meta_keyword }}"
                                        class="form-control form-control-sm" placeholder="Enter Category Meta Keyword">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea type="text" name="meta_description" class="form-control form-control-sm"
                                        rows="3"
                                        placeholder="Enter Category Meta Description">{{ $category->meta_description }}</textarea>
